...
import img4 from "../../assets/Imgs/delivery-man.png";

function Hero2() {
  return (
    <div className="mt-28 mx-4">
      <div className="grid grid-cols-1 lg:grid-cols-8 gap-4 max-w-7xl mx-auto ">
        ...
        <div className="lg:col-span-2 ">
          <div className=" grid grid-cols-1  items-center justify-center gap-2 ">
            <div className="flex rounded-xl  p-3 gap-5  border-2 border-gray-300  items-center justify-center">
